...
include_once("topbar.php");
                 ...
                 $sql_count = "SELECT * FROM `add_update_hotels` WHERE `approval` = 'Approved'";
                     $result_count = mysqli_query($conn, $sql_count);
                     $countHotel = mysqli_num_rows($result_count);
?>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="p-3 pb-0">
                                            <div class="float-right">
                                                <i class="mdi mdi-hotel text-primary widget-icon"></i>
                                            </div>
                                            <h5 class="text-muted font-weight-normal mt-0">Hotels</h5>
                                            <h3 class="mt-2"><?php echo isset($countHotel)?$countHotel:'';?></h3>
                                        </div>
