...
?>
               ...
               <table id="basic-datatable" class="table dt-responsive nowrap">
                ...
                <div class="row"> 
                  ...
                  <tbody>
                    <?php
                     // <!-- SQL Query in sidebar page line no. 80-84 -->
                    $i=0;
                          ...
                          <td style="width: 30%"> 
                           <div class="card d-block">
                              <a href="update_hotel.php?country=<?php echo $country; ?>&state=<?php echo $state; ?>&city=<?php echo $city; ?>&hotel_name=<?php echo $hotel_name ?>"> 
                                <?php if(empty($image_path[0])){ ?>
                                <img style="height:211px;" class="card-img-top img-fluid"  src="assets/images/Namaste-Dehradun-Photo-Not-Available.jpg">
                              <?php }else{ ?>
